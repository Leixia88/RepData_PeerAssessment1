...
hist( steps_per_day$total_steps, xlab = "Steps taken each day", main = "Histogram of steps")
```
...
hist( steps_per_day_nna$total_steps, xlab = "Steps taken each day", main = "Histogram of steps without missing value")
```
...
```r
print("Imputting the missing data increase the steps of both mean and median per day.")
```

```
## [1] "Imputting the missing data increase the steps of both mean and median per day."
```

```r
print("Imputting the missing date also equalise the mean and median steps per day.")
```

```
## [1] "Imputting the missing date also equalise the mean and median steps per day."
```
...
xyplot(log(avgStepsByWDays) ~ interval | DayType, steps_per_intv, layout = c(1,2), type = "l", ylab = "Number of steps")
```
